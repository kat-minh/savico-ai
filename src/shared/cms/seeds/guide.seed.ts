...
import type { GuideArticle, GuideVideo } from '../cms.types'
...
export const GUIDE_VIDEOS_SEED: GuideVideo[] = VIDEOS
export const GUIDE_ARTICLES_SEED: GuideArticle[] = ARTICLES
