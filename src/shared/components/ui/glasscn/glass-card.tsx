...
import { type FrostGlassVariant, type FrostGlassVariantProp, glassVariantStyles } from '@/shared/lib/glass-variants'
  ...
  if (glassVariant === 'liquid-refract') {
    return (
      <LiquidGlass
        {...liquidProps}
        className={cn(
          'rounded-2xl backdrop-blur-2xl supports-backdrop-filter:backdrop-blur-2xl',
      ...
      >
        <Card
          ...
          className={cn('border-0 bg-transparent shadow-none ring-0', className)}
          {...props}
        />
      </LiquidGlass>
    )
